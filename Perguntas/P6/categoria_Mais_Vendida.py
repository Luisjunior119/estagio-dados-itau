...
total_vendas_ordenadas = total_vendas_por_categoria.sort_values(ascending=False)

print("Quantidade total de vendas por categoria de produto:")
print(total_vendas_ordenadas)

categoria_mais_vendida = total_vendas_ordenadas.idxmax()
maior_venda = total_vendas_ordenadas.max()
print(f"A categoria de produto mais vendida é '{categoria_mais_vendida}' com um total de vendas de {maior_venda:.2f}")
